...
class SkillRouter:
    ...
    def route(
        self, user_prompt: str, project_context: dict[str, Any] | None = None
    ) -> RoutingResult:
    ...
    def _score_skill(
        self, skill_name: str, keywords: list[str], prompt: str, project_type: str | None
    ) -> float:
        ...
        if project_type:
            project_keyword_scores = {
                "rust": {
                    "debugging-and-error-recovery": 0.2,
                    "test-driven-development": 0.15,
                    "incremental-implementation": 0.15,
                },
                "python": {
                    "test-driven-development": 0.2,
                    "debugging-and-error-recovery": 0.15,
                    "spec-driven-development": 0.1,
                },
                "javascript": {
                    "frontend-ui-engineering": 0.15,
                    "test-driven-development": 0.15,
                    "incremental-implementation": 0.15,
                },
            }
