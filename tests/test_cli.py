...
class TestCLIArgumentParsing:
    def test_parse_args_basic(self):
        ...
        parser.add_argument(
            "-r", "--runtime", default="hermes", choices=["hermes", "kilo", "opencode"]
        )
...
class TestCLINoVerifyRegression:
    def test_no_verify_does_not_crash_on_missing_format_check(self, tmp_path):
        ...
        with (
            patch("agentcore.cli.main.Agent") as MockAgent,
            ...
            MockConfig.discover.return_value.to_agent_config.return_value = AgentConfig(
